...
class CombineAlignments(DependencyMetaTask):
    ...
    blastOutputFiles= glob.glob('alignment/hmmer/*%s*.blast' %projectID)
    blastOutputFiles+= glob.glob('alignment/blast/*/*%s*.blast' %projectID)
    ...
    def listDBHierarchies(self,db):
        pass

    #def 
        
    def extractReadAnnotations(self, blastOutputFiles, e_value_t=1e-5, perc_identity_t=60):
        """
        ...
        for blastOut in blastOutputFiles:
            ...
            for line in bOut:
               ...
               ### a confirmatory filtering takes place here 
                ...
                self.SampleFunctions[db][sample][function].append(read)
    ...
    def combine(self):
        ...
        self.extractReadAnnotations(self.blastOutputFiles)
        #self.printReads()
        self.printFunctions()
